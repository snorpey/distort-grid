...
define(
	...
	function( reqwest, $ )
	{
		...
		function imageUploaded( response )
		{
			...
			{
				var twitter_share_url_text = "Check out what I made with @snorpey’s image distortion tool: ";
				twitter_share_url_text += response.data.link;
				twitter_share_url_text += ' http://snorpey.github.io/distort-grid';
				...
				facebook_share_url += '&p[title]=BAAM!';
				facebook_share_url += '&p[images][0]=' + response.data.link;
				facebook_share_url += '&p[summary]=' + encodeURIComponent( 'Check out what I made with this image distortion tool: http://snorpey.github.io/distort-grid' );
				...
				reddit_link.href = 'http://www.reddit.com/submit?url=' + encodeURIComponent( response.data.link );
			}
